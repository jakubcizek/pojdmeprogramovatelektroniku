...
uint16_t getOverCurrentDetection(uint8_t ocd) {
    switch (ocd) {
        case dSPIN_OCD_TH_375mA:
            return 375;
        case dSPIN_OCD_TH_750mA:
            return 750;
        case dSPIN_OCD_TH_1125mA:
            return 1125;
        case dSPIN_OCD_TH_1500mA:
            return 1500;
        case dSPIN_OCD_TH_1875mA:
            return 1875;
        case dSPIN_OCD_TH_2250mA:
            return 2250;
        case dSPIN_OCD_TH_2625mA:
            return 2625;
        case dSPIN_OCD_TH_3000mA:
            return 3000;
        case dSPIN_OCD_TH_3375mA:
            return 3375;
        case dSPIN_OCD_TH_3750mA:
            return 3750;
        case dSPIN_OCD_TH_4125mA:
            return 4125;
        case dSPIN_OCD_TH_4500mA:
            return 4500;
        case dSPIN_OCD_TH_4875mA:
            return 4875;
        case dSPIN_OCD_TH_5250mA:
            return 5250;
        case dSPIN_OCD_TH_5625mA:
            return 5625;
        case dSPIN_OCD_TH_6000mA:
            return 6000;
        default:
            return 0; // Neplatná hodnota
    }
}
